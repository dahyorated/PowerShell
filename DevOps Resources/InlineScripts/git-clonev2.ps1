# Version that works in pipeline with vs2017-win2016 agent
...
try
{
	Write-Output "git -c http.extraheader=""Authorization: bearer $ENV:SYSTEM_ACCESSTOKEN"" clone $repoUrl;";
...
try
{
	Write-Output "git -c http.extraheader=""Authorization: bearer $ENV:SYSTEM_ACCESSTOKEN"" push;";
